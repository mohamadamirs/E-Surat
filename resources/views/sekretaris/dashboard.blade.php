    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                ...
                <a href="{{ route('sekretaris.surat-masuk.index') }}" class="small-box-footer">Lihat Detail <i
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                ...
                <a href="{{ route('sekretaris.surat-keluar.index') }}" class="small-box-footer">Lihat Detail <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-6">
        ...
        <div class="col-md-7">
            <div class="card">
                        ...
                        <table class="table m-0">
                            ...
                            <tbody>
                                @forelse ($suratMasukTerbaru as $surat)
                                    <tr>
                                        <td><a
                                                href="{{ route('sekretaris.surat-masuk.show', $surat->id) }}">{{ $surat->nomor_surat }}</a>
                                        </td>
                ...
                <div class="card-footer clearfix text-center">
                    <a href="{{ route('sekretaris.surat-masuk.index') }}" class="btn btn-primary ">Lihat Semua
                        Surat Masuk</a>
                </div>
            </div>
        </div>
                        ...
                        @forelse ($disposisiTerbaru as $item)
                            <li class="item">
                                <div class="product-info">
                                    <a href="{{ route('sekretaris.surat-masuk.show', $item->id_surat_masuk) }}"
                                        class="product-title">
                                        ...
                                        @elseif($item->status_validasi == 'Revisi')
                                            <span class="badge badge-info float-right">Revisi</span>
                                        @endif
                                    </a>
                                    <span class="product-description">
                                        Diteruskan ke {{ $item->kepala->name }} pada
